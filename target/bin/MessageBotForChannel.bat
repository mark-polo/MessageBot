...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="MessageBotForChannel" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.message.bot.Main %CMD_LINE_ARGS%
